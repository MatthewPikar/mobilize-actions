...
describe('Resource Service', function(){
    ...
    describe('query', function(){
        ...
        it('Should return a 200/204 status and ignore malformed options fields and bad query characters', function(){
            var queryMalformed =        act({role: resourceName, cmd: 'query', requestId:'test5', query: 0})
            var queryHasBadCharacters = act({role: resourceName, cmd: 'query', requestId:'test5', query:'i.see=a}nose'})
        ...
        it('Should return a 200 status along with the resource corresponding to the provided query.', function(){
            ...
            var result2 = act({role: resourceName, cmd: 'query', requestId: 'test1', query:'wheel'})
